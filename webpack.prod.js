...
var imagemin_webpack_plugin_1 = require("imagemin-webpack-plugin");
...
var config = function (env, argv) {
    return {
        ...
        module: {
            rules: ModuleRules_1.ModuleRulesProduct
        },
        plugins: Contents_1.Contents.map(function (item) {
            ...
            return new HtmlWebpackPlugin(__assign({}, props, CommonHTMLProps_1.CommonHTMLPropsProduction, { meta: __assign({}, CommonHTMLProps_1.CommonHTMLPropsProduction.meta, meta, { description: description }), title: rawTitle ? rawTitle : Title_1.Title(title), template: "./src/templates/" + template }));
        }).concat([
